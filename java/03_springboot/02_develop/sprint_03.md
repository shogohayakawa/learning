...
|★||タイトル|テキストボックス|「つぶやき登録ボタン」から遷移した場合、空白を初期表示する。<br>「つぶやき登録確認画面」から遷移した場合、入力済みのデータを初期表示する。|
...
|★|「つぶやき確認」ボタン|-|ボタン|クリックするとバリデーションチェックを行う。<br>エラーがない場合、「タイトル」と「つぶやき」に設定されたデータをつぶやき登録確認画面へ渡す。<br>エラーがある場合、つぶやき登録画面の所定箇所にエラーメッセージを表示する。|
...
|★||「登録」ボタン|ボタン|クリックするとバリデーションチェックを行う。<br>エラーがない場合、「タイトル」と「つぶやき」に入力されたデータをboardsテーブルに登録し、タイムライン画面へリダイレクトする。<br>エラーがある場合、つぶやき登録画面の所定箇所にエラーメッセージを表示する。|
